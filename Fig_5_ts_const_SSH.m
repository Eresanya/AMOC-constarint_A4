...
%     };
 ...
 %    'MPI-ESM1-2-HR','MRI-ESM2-0','NorESM2-LM','SAM0-UNICON','NESM3','UKESM1-0-LL'}; 
...
% ---------------------------------------------------------
% --- Constrained correlations
text(1943,2.10,...
    sprintf('1950–1990: r = %.2f', r_con_p1),...
    'FontSize',10,...
    'FontWeight','bold',...
    'Color',col_con,...
    'BackgroundColor','w',...
...
text(1943,1.85,...
    sprintf('1990–2014: r = %.2f', r_con_p2),...
    'FontSize',10,...
    'FontWeight','bold',...
    'Color',col_con,...
    'BackgroundColor','w',...
...
% --- Unconstrained correlations
text(1943,1.45,...
    sprintf('1950–1990: r = %.2f', r_un_p1),...
    'FontSize',10,...
    'FontWeight','bold',...
    'Color',col_un,...
    'BackgroundColor','w',...
...
text(1943,1.20,...
    sprintf('1990–2014: r = %.2f', r_un_p2),...
    'FontSize',10,...
    'FontWeight','bold',...
    'Color',col_un,...
    'BackgroundColor','w',...
